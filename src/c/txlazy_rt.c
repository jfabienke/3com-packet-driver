/**
 * @file txlazy_rt.c
 * @brief Lazy TX Interrupt Optimization - Runtime Functions (ROOT Segment)
 *
 * Created: 2026-01-28 09:17:48 UTC
 *
 * This file contains runtime TX lazy IRQ functions that are called during
 * active packet TX operations, including from ISR context. These functions
 * must remain memory-resident (ROOT segment) for performance and reliability
 * during high-frequency network operations.
 *
 * Functions included:
 * - tx_lazy_should_interrupt - Decide if TX descriptor requests interrupt
 * - tx_lazy_post_boomerang - Post TX for Boomerang/Cyclone/Tornado NICs
 * - tx_lazy_post_vortex - Post TX for Vortex PIO mode
 * - tx_lazy_reclaim_batch - Batch TX completion handler
 *
 * Split from txlazy.c for memory segmentation optimization.
 * Init/cleanup functions are in txlazy_init.c (OVERLAY segment).
 */
...
/*==============================================================================
 * Global state definitions (extern'd by txlazy_init.c)
 *==============================================================================*/
...
/*==============================================================================
 * Runtime TX functions - called during packet transmission
 *==============================================================================*/
