/**
 * @file dmabnd_rt.c
 * @brief DMA Boundary Checking - Runtime Functions (ROOT Segment)
 *
 * Created: 2026-01-28 08:18:53 CET
 *
 * This file contains runtime DMA boundary checking functions that are called
 * during active packet TX/RX operations, including interrupt handlers. These
 * functions must remain memory-resident (ROOT segment) for performance and
 * reliability during high-frequency network operations.
 *
 * Functions included:
 * - DMA boundary checking functions used during packet I/O
 * - Buffer alignment verification
 * - Cross-boundary detection (64KB and 16MB)
 * - Physical address calculation with EMM386/QEMM awareness
 * - Bounce buffer allocation/release for TX/RX
 * - Scatter-gather descriptor management
 * - Physical contiguity verification
 * - Page locking for DMA operations
 *
 * Split from dmabnd.c for memory segmentation optimization.
 * Init/cleanup functions are in dmabnd_init.c (OVERLAY segment).
 *
 * GPT-5 Improvements:
...
/*==============================================================================
 * Global state definitions (shared with dmabnd_init.c)
 *==============================================================================*/

/* Global bounce buffer pools - accessed from ISR and main context */
bounce_pool_t g_tx_bounce_pool = {0};
bounce_pool_t g_rx_bounce_pool = {0};
bool g_bounce_pools_initialized = false;

/* Statistics tracking - updated from ISR */
dma_boundary_stats_t g_boundary_stats = {0};
...
/*==============================================================================
 * DMA Buffer Safety Checking Functions
 *==============================================================================*/
...
/*==============================================================================
 * Physical Address Calculation Functions
 *==============================================================================*/
...
/*==============================================================================
 * Bounce Buffer Pool Management (Runtime Operations)
 *==============================================================================*/
...
/*==============================================================================
 * Scatter-Gather Descriptor Functions
 *==============================================================================*/
