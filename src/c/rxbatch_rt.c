/**
 * @file rxbatch_rt.c
 * @brief Batched RX buffer refill - runtime code (ROOT segment)
 *
 * Contains RX batch processing functions called during packet reception,
 * buffer management functions used at runtime, and ISR context functions.
 *
...
/* Per-NIC RX batch state - global for init module access */
