...
%include "csym.inc"
        ...
        global  quiesce_handler
        global  resume_handler
        global  get_dma_stats

        ; External references (linkstubs.c defines these with underscore)
        extern  nic_io_base
        extern  nic_irq
        extern  isr_active
...
quiesce_handler:
        ...
        cmp     byte [cs:driver_quiesced], 1
        je      .already_quiesced

        ; Bounded wait for ISR to clear (10 retries)
        mov     cx, 10
.wait_isr:
        test    byte [cs:isr_active], 1
        jz      .isr_clear
...
.done:
        ...
        mov     byte [cs:driver_quiesced], 1
        inc     byte [cs:quiesce_count]
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        global  increment_bounce_counter
increment_bounce_counter:
        inc     word [cs:bounce_counter]
        ret

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Report boundary violation (called from boundary check)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        global  report_boundary_violation
report_boundary_violation:
        inc     word [cs:boundary_violations]
        ret

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Verify IRQ2 cascade state after resume
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        global  verify_cascade_state
verify_cascade_state:
        push    ax
        push    cx
