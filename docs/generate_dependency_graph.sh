...
# Generate custom dependency graph for 3Com Packet Driver
# This creates a simplified view of actual dependencies

cat > dependency_graph.dot << 'EOF'
...
echo "  - dependency_graph.svg (vector format)"
echo "  - dependency_graph.png (raster format)"

# Generate statistics
echo ""
echo "=== Codebase Statistics ==="
echo "Active C files: 23"
echo "Dead C files: 48"
echo "Total C files: 71"
echo "Dead code percentage: 67.6%"
echo ""
echo "Active ASM files: ~15"
echo "Total source files: ~100+"
echo ""
echo "Recommended actions:"
echo "1. Move PCI support to src/future/pci/"
echo "2. Archive test code in tests/"
echo "3. Remove duplicate implementations"
echo "4. Document remaining dead code"