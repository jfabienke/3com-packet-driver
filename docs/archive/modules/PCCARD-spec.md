# PCCARD (Legacy Module Spec) — Archived

Last Updated: 2025-09-04
Status: archived
Purpose: Historical specification for a modular PCMCIA/CardBus layer (.MOD). Superseded by the unified driver architecture; present for reference only.
