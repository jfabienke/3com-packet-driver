...
#endif
#ifdef __WATCOMC__
#include <i86.h>    /* For FP_SEG, FP_OFF, MK_FP macros on Watcom */
#endif

/* Portability layer - must come before I/O macros are used */
#include "portabl.h"
...
#define ERROR_NOT_INITIALIZED   -11     /* Service not initialized */
#define ERROR_INVALID_PARAMETER -12     /* Invalid parameter */
#define ERROR_DEVICE_EXISTS     -13     /* Device already exists */
#define ERROR_REGISTRY_FULL     -14     /* Registry full */
#define ERROR_DEVICE_NOT_FOUND  -15     /* Device not found */
#define ERROR_DEVICE_BUSY       -16     /* Device busy/claimed */
#define ERROR_DEVICE_NOT_CLAIMED -17    /* Device not claimed */
#define ERROR_ACCESS_DENIED     -18     /* Access denied */
#define ERROR_HARDWARE_NOT_FOUND -19    /* Hardware not found */
#define ERROR_MODULE_NOT_READY  -20     /* Module not ready */
#define ERROR_MEMORY_ALLOC      -21     /* Memory allocation failed */
#define ERROR_BUFFER_FULL       -25     /* Buffer is full */
#define ERROR_PARTIAL           -26     /* Partial completion */
#define ERROR_QUEUE_FULL        -27     /* Queue is full */

/* ISR Safety error codes */
#define ERROR_ISR_UNSAFE        -22     /* ISR safety violation */
#define ERROR_ISR_REENTRANT     -23     /* ISR reentrancy detected */
#define ERROR_ISR_STACK_OVERFLOW -24    /* ISR stack overflow */
#define WARNING_ISR_SLOW        1       /* ISR execution time warning */

/* Error subsystem codes for structured error handling */
#define ERROR_SUBSYS_MEMORY     0x01    /* Memory subsystem */
#define ERROR_SUBSYS_INTERRUPT  0x02    /* Interrupt subsystem */
#define ERROR_SUBSYS_NETWORK    0x03    /* Network subsystem */
#define ERROR_SUBSYS_HARDWARE   0x04    /* Hardware subsystem */
#define ERROR_SUBSYS_DRIVER     0x05    /* Driver subsystem */

/* Macro to construct structured error codes:
 * bits 31-24: severity, bits 23-16: subsystem, bits 15-0: specific error */
#define MAKE_ERROR(severity, subsys, code) \
    ((int32_t)((((uint32_t)(severity) & 0xFF) << 24) | \
               (((uint32_t)(subsys) & 0xFF) << 16) | \
               ((uint32_t)(code) & 0xFFFF)))

/* Hardware I/O macros - compatible with both C and Assembly */
#ifndef __ASSEMBLER__

/* I/O port access functions - provided by portabl.h macros (IO_OUT8, etc.)
 * Do NOT declare outb/inb/outw/inw here as they are #defined in portabl.h
 * and declaring them as functions causes macro expansion errors.
 */
/* 32-bit I/O only - not covered by portabl.h */
...
uint32_t get_system_ticks(void);  /* BIOS timer tick count */
...
/* NIC context - forward declaration, full definition in nicctx.h */
...
/* Bus type enumeration - C89 compatible (no explicit initializers) */
typedef enum {
    BUS_TYPE_UNKNOWN,    /* 0: Unknown */
    BUS_TYPE_ISA,
    BUS_TYPE_EISA,
